...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { age: @cat.age, description: @cat.description, image: @cat.image, name: @cat.name }
    end
  ...
  test "should update cat" do
    put :update, id: @cat, cat: { age: @cat.age, description: @cat.description, image: @cat.image, name: @cat.name }
    assert_redirected_to cat_path(assigns(:cat))
  end
